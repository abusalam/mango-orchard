        ...
        <div class="rounded-2xl border border-amber-200 bg-white shadow-sm p-8 sm:p-10" data-testid="cookies-required-card">
            <div class="flex items-start gap-4">
                ...
                <div class="min-w-0 flex-1">
                    <h1 class="text-2xl sm:text-3xl font-semibold tracking-tight text-stone-900">Cookies are needed for this</h1>
            ...
            <div class="mt-6 grid sm:grid-cols-2 gap-4">
                <div class="rounded-xl border border-stone-200 p-4 bg-stone-50">
                    <h2 class="text-sm font-semibold text-stone-900">Necessary only</h2>
                ...
                <div class="rounded-xl border border-stone-200 p-4 bg-stone-50">
                    <h2 class="text-sm font-semibold text-stone-900">Accept all</h2>
                    <p class="mt-1 text-xs text-stone-600 leading-relaxed">
            ...
            @if ($return)
                ...
                <p class="mt-2 text-xs text-stone-500" data-testid="cookies-required-return">
                    Heading to: <code class="text-stone-700">{{ $return }}</code>
                </p>
            @endif

            <div class="mt-8 flex flex-wrap gap-3 text-sm">
                <a href="{{ route('home') }}" class="inline-flex items-center px-4 py-2 rounded-full border border-stone-300 text-stone-700 hover:bg-stone-50 transition-colors">
                    Back to home
                </a>
                <a href="{{ route('varieties.index') }}" class="inline-flex items-center px-4 py-2 rounded-full border border-stone-300 text-stone-700 hover:bg-stone-50 transition-colors">
                    Browse varieties
                </a>
                <a href="{{ route('listings.index') }}" class="inline-flex items-center px-4 py-2 rounded-full border border-stone-300 text-stone-700 hover:bg-stone-50 transition-colors">
                    Browse marketplace
                </a>
            </div>
        </div>
