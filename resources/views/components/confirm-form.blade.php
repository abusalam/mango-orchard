...
>
    ...
    <dialog
        ...
        class="rounded-2xl border border-stone-200 bg-white text-stone-900 p-0 w-full max-w-md shadow-2xl backdrop:bg-stone-900/50 backdrop:backdrop-blur-sm"
    >
        <div class="p-6 sm:p-7">
            <h2 class="text-lg font-semibold tracking-tight">{{ $title }}</h2>
            @if ($message)
                <p class="mt-2 text-sm text-stone-600 leading-relaxed">{{ $message }}</p>
            @endif
            ...
            <div class="mt-6 flex justify-end gap-3">
                <button
                    ...
                    class="inline-flex items-center px-4 py-2 rounded-full border border-stone-200 text-stone-700 font-medium hover:border-stone-400 transition-colors text-sm"
