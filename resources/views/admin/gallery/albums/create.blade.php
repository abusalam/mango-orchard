<x-admin-layout title="New album — Mango Gallery" active="gallery">
    ...
    <header class="mb-6">
        <h1 class="text-3xl font-semibold tracking-tight">New album</h1>
        <p class="mt-1 text-stone-600 dark:text-stone-300 text-sm">Create the album first; once saved, photos can be uploaded on the edit page.</p>
    </header>
