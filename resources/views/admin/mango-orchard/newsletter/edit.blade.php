<x-admin-layout :title="$issue->exists ? 'Edit issue' : 'New issue'" active="mango-newsletter">
    ...
    <form method="POST"
        ...
        <div>
            ...
            <p class="mt-1 text-xs text-stone-500">Markdown supported (<code>**bold**</code>, <code>[link](url)</code>). Separate paragraphs with a blank line.</p>
        ...
        <div class="flex items-center gap-3 pt-2 border-t border-stone-100">
            ...
            <a href="{{ route('admin.mango-orchard.newsletter.index') }}" class="text-sm text-stone-500 hover:text-stone-900">Cancel</a>
        </div>
    </form>
