<x-admin-layout title="New designation" active="monitoring-designations">
    ...
    <form method="POST" action="{{ route('admin.monitoring.designations.store') }}" class="bg-white dark:bg-stone-950 rounded-2xl border border-stone-200 dark:border-stone-800 p-6 max-w-2xl">
