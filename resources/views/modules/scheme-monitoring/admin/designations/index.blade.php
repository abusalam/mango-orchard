<x-admin-layout title="Designations" active="monitoring">
        ...
        @else
            <table class="w-full text-sm">
                <thead class="bg-stone-50 text-stone-500 text-left">
                    <tr><th class="px-4 py-2">Name</th><th class="px-4 py-2">Level</th><th class="px-4 py-2">Description</th><th></th></tr>
                </thead>
