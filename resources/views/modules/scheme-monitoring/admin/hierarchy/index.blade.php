            ...
            <table class="w-full text-sm">
                ...
                <tbody class="divide-y divide-stone-100 dark:divide-stone-800">
                    @foreach ($allMonitors as $monitor)
                        ...
                        <tr class="odd:bg-white dark:odd:bg-stone-950 dark:bg-stone-950 even:bg-stone-50/50 dark:even:bg-stone-900" data-testid="hierarchy-row-{{ $monitor->id }}">
                            <td class="px-4 py-3 align-top">
                                <p class="font-medium">{{ $monitor->name }}</p>
                                <p class="text-xs text-stone-500 dark:text-stone-400">{{ $monitor->email }}</p>
                            </td>
                            <td class="px-4 py-3 align-top">
