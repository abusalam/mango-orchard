<x-site-layout :title="'New task — '.config('app.name')">
    <section class="mx-auto max-w-2xl px-4 sm:px-6 lg:px-8 py-8">
        ...
        <form method="POST" action="{{ route('monitoring.tasks.store') }}" class="bg-white dark:bg-stone-950 rounded-2xl border border-stone-200 dark:border-stone-800 p-6">
