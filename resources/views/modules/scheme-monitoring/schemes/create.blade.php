<x-site-layout :title="'New scheme — Aamar Malda'">
    <section class="mx-auto max-w-2xl px-4 sm:px-6 lg:px-8 py-8">
        ...
        <form method="POST" action="{{ route('monitoring.schemes.store') }}" class="bg-white rounded-2xl border border-stone-200 p-6">
