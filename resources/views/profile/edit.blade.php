        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="lg:grid lg:grid-cols-[220px_minmax(0,1fr)] lg:gap-8 lg:max-w-5xl lg:mx-auto">
                ...
                <aside class="mb-6 lg:mb-0"
                    ...
                    <nav class="lg:sticky lg:top-20 bg-white rounded-2xl border border-stone-200 p-2 text-sm" data-testid="profile-sidebar-nav">
                        <a href="#profile-information"
                           x-bind:class="active === 'profile-information' ? 'bg-orange-50 text-orange-900' : 'text-stone-700 hover:bg-stone-100'"
                        ...
                        <a href="#preferences"
                           x-bind:class="active === 'preferences' ? 'bg-orange-50 text-orange-900' : 'text-stone-700 hover:bg-stone-100'"
                        ...
                        <a href="#role-applications"
                           x-bind:class="active === 'role-applications' ? 'bg-orange-50 text-orange-900' : 'text-stone-700 hover:bg-stone-100'"
                           ...
                           class="flex items-center justify-between gap-2 px-3 py-2 rounded-lg font-medium transition-colors">
                            ...
                            @if ($pendingApplicationsCount > 0)
                                <span class="inline-flex items-center px-1.5 py-0.5 rounded-full text-[10px] font-medium bg-amber-100 text-amber-900 border border-amber-200" data-testid="sidebar-badge-applications">{{ $pendingApplicationsCount }}</span>
                            @endif
                        </a>
                        <a href="#role-delegations"
                           x-bind:class="active === 'role-delegations' ? 'bg-orange-50 text-orange-900' : 'text-stone-700 hover:bg-stone-100'"
                           ...
                           class="flex items-center justify-between gap-2 px-3 py-2 rounded-lg font-medium transition-colors">
                            ...
                            @if ($delegationsActiveCount > 0)
                                <span class="inline-flex items-center px-1.5 py-0.5 rounded-full text-[10px] font-medium bg-stone-100 text-stone-700 border border-stone-200" data-testid="sidebar-badge-delegations">{{ $delegationsActiveCount }}</span>
                            @endif
                        </a>
                        <a href="#password"
                           x-bind:class="active === 'password' ? 'bg-orange-50 text-orange-900' : 'text-stone-700 hover:bg-stone-100'"
                        ...
                        <a href="#danger-zone"
                           x-bind:class="active === 'danger-zone' ? 'bg-rose-100 text-rose-900' : 'text-rose-700 hover:bg-rose-50'"
                ...
                <main class="space-y-6 min-w-0">
                    <section id="profile-information" class="scroll-mt-24 p-4 sm:p-8 bg-white border border-stone-200 rounded-2xl">
                        <div class="max-w-xl">
                            @include('profile.partials.update-profile-information-form')
                        </div>
                    </section>

                    <section id="preferences" class="scroll-mt-24 p-4 sm:p-8 bg-white border border-stone-200 rounded-2xl">
                        <div class="max-w-xl">
                            @include('profile.partials.update-preferences-form')
                        </div>
                    </section>

                    <section id="role-applications" class="scroll-mt-24 p-4 sm:p-8 bg-white border border-stone-200 rounded-2xl">
                        <div class="max-w-2xl">
                            @include('profile.partials.request-role-form')
                        </div>
                    </section>

                    <section id="role-delegations" class="scroll-mt-24 p-4 sm:p-8 bg-white border border-stone-200 rounded-2xl">
                        <div class="max-w-2xl">
                            @include('profile.partials.delegate-role-form')
                        </div>
                    </section>

                    <section id="password" class="scroll-mt-24 p-4 sm:p-8 bg-white border border-stone-200 rounded-2xl">
                        <div class="max-w-xl">
                            @include('profile.partials.update-password-form')
                        </div>
                    </section>

                    <section id="danger-zone" class="scroll-mt-24 p-4 sm:p-8 bg-white border border-rose-200 rounded-2xl">
                        <div class="max-w-xl">
