...
class UpdateMangoVarietyRequest extends FormRequest
{
    ...
    {
        /** @var MangoVariety $variety */
        $variety = $this->route('variety');

        return [
            'name' => ['required', 'string', 'max:120', Rule::unique('mango_varieties', 'name')->ignore($variety->id)],
